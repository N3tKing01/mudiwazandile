    ...
    try {
        ...
        if (!url) {
            return await sock.sendMessage(chatId, { 
                text: "❌ Sicela unikeze a valid URL to fetch." 
        ...
        try {
            ...
            return await sock.sendMessage(chatId, { 
                text: "❌ Invalid URL format. Sicela unikeze  Sicela unikeze a valid URL." 
            }, { quoted: createFakeContact(message) });
        }
        ...
        if (contentType.includes('application/json')) {
            try {
                ...
                return await sock.sendMessage(chatId, { 
                    text: "❌ Failed to paste JSON. Sending as text.\n" + buffer.toString() 
                }, { quoted: createFakeContact(message) });
            }
        }
        ...
        let errorMessage = "❌ Yehlulekile to fetch the URL. ";
        ...
        if (error.code === 'ECONNABORTED') {
            ...
            errorMessage += "Ngicela uhlole the URL and try again.";
        }
