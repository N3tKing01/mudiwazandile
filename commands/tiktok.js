    ...
    try {
        ...
        if (!text) {
            return await sock.sendMessage(chatId, { 
                text: "Ngiyacela hlinzeka a TikTok link for the video."
            }, { quoted: fakeQuoted });
        }
        ...
        if (!isValidUrl) {
            return await sock.sendMessage(chatId, { 
                text: "Lokho akulona iqiniso TikTok link. Ngiyacela hlinzeka a iqiniso TikTok video link."
            }, { quoted: fakeQuoted });
        }
        ...
        try {
            ...
            if (data && data.status && data.result) {
                ...
                return await sock.sendMessage(chatId, {
                    text: "Yehlulekile ukulanda video. Ngiyacela check the link or try again later."
                }, { quoted: fakeQuoted });
            }
            ...
            await sock.sendMessage(chatId, {
                text: "Yehlulekile ukulanda  the TikTok video. Ngiyacela ukuzama futhi."
            }, { quoted: fakeQuoted });
        }
    } catch (error) {
        console.error('Error in TikTok command:', error.message || error);
        await sock.sendMessage(chatId, {
            text: "An unexpected error occurred. Ngiyacela ukuzama again."
        }, { quoted: fakeQuoted });
    }
}
