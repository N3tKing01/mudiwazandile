...
async function kickAllCommand(sock, chatId, message, senderId) {
    ...
    try {
        ...
        try {
            ...
            return await sock.sendMessage(groupId, {
                text: '❌ Yehlulekile ukulanda group information. Make sure I\'m in the group.'
            }, { quoted: fake }).catch(() => {});
        }
        ...
        try {
            ...
            console.error('Yehlulekile ukuhlola sender admin status:', error);
        }
        ...
        await sock.sendMessage(groupId, {
            text: `⏳ Kicking *${targets.length}* member(s), Ngicela ulinde...`
        }, { quoted: fake }).catch(() => {});
        ...
        try {
            ...
            console.error('Yehlulekile ukuthumela error message:', finalError);
        }
    }
}
