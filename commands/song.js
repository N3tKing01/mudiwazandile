    ...
    try {
        ...
        if (!searchQuery) {
            return await sock.sendMessage(chatId, { 
                text: "Urikutsvaka song yakadini yauri kuda kudownloader?"
            }, { quoted: fakekontak });
        }
        //react 
        ...
        if (!data || !data.status) {
            return await sock.sendMessage(chatId, { 
                text: "Ndatadza kufetcher audio kubva paAPI. Ngiyacela ukuzama futhi nor Chikumbiro zama zvekare."
            }, { quoted: fakekontak });
        }
        ...
        await sock.sendMessage(chatId, { 
            text: "☠️Ndatadza kuwana song. Ndine chikumbiro zama muchikamu chinotevera/ ngiyehlulekile ukuthola ingoma. ngiyacela ukuzama futhi."
        }, { quoted: fakekontak });
    }
}
