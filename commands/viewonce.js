    ...
    if (quotedImage && quotedImage.viewOnce) {
        ...
        await sock.sendMessage(
            ...
            { 
                image: buffer, 
                fileName: 'media.jpg', 
                caption: quotedImage.caption || '📸 View-once image retrieved by LDT-Joshuamambo1!' 
            }, 
            { quoted: message }
        );
        ...
        await sock.sendMessage(
            ...
            { 
                video: buffer, 
                fileName: 'media.mp4', 
                caption: quotedVideo.caption || '🎥 View-once video retrieved by LDT-Joshuamambo1!' 
            }, 
            { quoted: message }
        );
        await sock.sendMessage(chatId, { react: { text: '✅', key: message.key } });
        ...
        await sock.sendMessage(
            ...
            { 
                ...
                caption: '🎵 View-once audio retrieved by LDT-Joshuamambo1!' 
            }, 
            { quoted: message }
        );
        await sock.sendMessage(chatId, { react: { text: '✅', key: message.key } });
