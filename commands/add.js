    ...
    if (text) {
      ...
      if (extractedNumber.length === 0) {
        return sock.sendMessage(chatId, { 
          text: "📌 Usage: `.add 263xxxxxxx` or reply to a user's message\n\n⚠️ *Please provide a phone number* (e.g., .add 263738365135)" 
      ...
      return sock.sendMessage(chatId, { 
        text: "📌 Usage: `.add 2637xxxxxxx` or reply to a user's message\n\n⚠️ *Please provide a phone number* (e.g., .add 263738365135)" 
      }, { quoted: createFakeContact(message) });
    }
